...
df_anger_en_train = pd.read_csv("train_data/En-train/txt/EI-reg-en_anger_train.txt", header=None, names=["text", "emotion", "intensity"], sep="\t")
df_anger_en_dev = pd.read_csv("dev_data/En-dev/txt/2018-EI-reg-En-anger-dev.txt", header=None, names=["text", "emotion", "intensity"], sep="\t")
df_anger_es_train = pd.read_csv("train_data/Es-train/txt/2018-EI-reg-Es-anger-train.txt", header=None, names=["text", "emotion", "intensity"], sep="\t")
df_anger_es_dev = pd.read_csv("dev_data/Es-dev/txt/2018-EI-reg-Es-anger-dev.txt", header=None, names=["text", "emotion", "intensity"], sep="\t")
