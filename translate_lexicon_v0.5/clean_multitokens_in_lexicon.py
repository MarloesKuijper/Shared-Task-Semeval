...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: clean_multitoken_in_lexicon.py <lexicon> <target>")  # token position starts from 0!
        print()
        print("Usage: python3 bash.py NRC-lexicon.txt NRC-lexicon_cleaned.txt")
        print()
        sys.exit (1)
    else:
